...
def get_argument_parser():
    ...
    parser.add_argument('--rate_img_drop', type=float, default=0.1)
    parser.add_argument('--rate_txt_drop', type=float, default=0.1)
    parser.add_argument('--rate_img_exchange', type=float, default=0.8)
    parser.add_argument('--rate_txt_exchange', type=float, default=0.8)
    parser.add_argument('--rate_se', type=float, default=0.33)
    parser.add_argument('--rate_sa', type=float, default=0.33)
